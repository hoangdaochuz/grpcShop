...
export namespace google.protobuf {
    ...
    export class FieldOptions extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("feature_support" in data && data.feature_support != undefined) {
                    this.feature_support = data.feature_support;
                }
                this.uninterpreted_option = data.uninterpreted_option;
            }
        }
        ...
        set feature_support(value: FieldOptions.FeatureSupport) {
            pb_1.Message.setWrapperField(this, 22, value);
        }
        get has_feature_support() {
        ...
        static fromObject(data: {
            ...
            features?: ReturnType<typeof FeatureSet.prototype.toObject>;
            feature_support?: ReturnType<typeof FieldOptions.FeatureSupport.prototype.toObject>;
            uninterpreted_option?: ReturnType<typeof UninterpretedOption.prototype.toObject>[];
        }): FieldOptions {
            ...
            if (data.feature_support != null) {
                message.feature_support = FieldOptions.FeatureSupport.fromObject(data.feature_support);
            }
            return message;
        }
        toObject() {
            ...
            if (this.feature_support != null) {
                data.feature_support = this.feature_support.toObject();
            }
            if (this.uninterpreted_option != null) {
                data.uninterpreted_option = this.uninterpreted_option.map((item: UninterpretedOption) => item.toObject());
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_feature_support)
                writer.writeMessage(22, this.feature_support, () => this.feature_support.serialize(writer));
            if (this.uninterpreted_option.length)
                writer.writeRepeatedMessage(999, this.uninterpreted_option, (item: UninterpretedOption) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 21:
                        ...
                        break;
                    case 22:
                        reader.readMessage(message.feature_support, () => message.feature_support = FieldOptions.FeatureSupport.deserialize(reader));
                        break;
                    case 999:
                        reader.readMessage(message.uninterpreted_option, () => pb_1.Message.addToRepeatedWrapperField(message, 999, UninterpretedOption.deserialize(reader), UninterpretedOption));
                        break;
    ...
    export namespace FieldOptions {
        ...
        export class FeatureSupport extends pb_1.Message {
            ...
            constructor(data?: any[] | {
                ...
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
                if (!Array.isArray(data) && typeof data == "object") {
                    if ("edition_introduced" in data && data.edition_introduced != undefined) {
                        this.edition_introduced = data.edition_introduced;
                    }
                    if ("edition_deprecated" in data && data.edition_deprecated != undefined) {
                        this.edition_deprecated = data.edition_deprecated;
                    }
                    if ("deprecation_warning" in data && data.deprecation_warning != undefined) {
                        this.deprecation_warning = data.deprecation_warning;
                    }
                    if ("edition_removed" in data && data.edition_removed != undefined) {
                        this.edition_removed = data.edition_removed;
                    }
                }
            }
            get edition_introduced() {
                return pb_1.Message.getFieldWithDefault(this, 1, Edition.EDITION_UNKNOWN) as Edition;
            }
            set edition_introduced(value: Edition) {
                pb_1.Message.setField(this, 1, value);
            }
            get has_edition_introduced() {
                return pb_1.Message.getField(this, 1) != null;
            }
            get edition_deprecated() {
                return pb_1.Message.getFieldWithDefault(this, 2, Edition.EDITION_UNKNOWN) as Edition;
            }
            set edition_deprecated(value: Edition) {
                pb_1.Message.setField(this, 2, value);
            }
            get has_edition_deprecated() {
                return pb_1.Message.getField(this, 2) != null;
            }
            get deprecation_warning() {
                return pb_1.Message.getFieldWithDefault(this, 3, "") as string;
            }
            set deprecation_warning(value: string) {
                pb_1.Message.setField(this, 3, value);
            }
            get has_deprecation_warning() {
                return pb_1.Message.getField(this, 3) != null;
            }
            get edition_removed() {
                return pb_1.Message.getFieldWithDefault(this, 4, Edition.EDITION_UNKNOWN) as Edition;
            }
            set edition_removed(value: Edition) {
                pb_1.Message.setField(this, 4, value);
            }
            get has_edition_removed() {
                return pb_1.Message.getField(this, 4) != null;
            }
            static fromObject(data: {
                edition_introduced?: Edition;
                ...
                if (data.edition_introduced != null) {
                    message.edition_introduced = data.edition_introduced;
                }
                if (data.edition_deprecated != null) {
                    message.edition_deprecated = data.edition_deprecated;
                }
                if (data.deprecation_warning != null) {
                    message.deprecation_warning = data.deprecation_warning;
                }
                if (data.edition_removed != null) {
                    message.edition_removed = data.edition_removed;
                }
                return message;
            }
            toObject() {
                ...
                if (this.edition_introduced != null) {
                    data.edition_introduced = this.edition_introduced;
                }
                if (this.edition_deprecated != null) {
                    data.edition_deprecated = this.edition_deprecated;
                }
                if (this.deprecation_warning != null) {
                    data.deprecation_warning = this.deprecation_warning;
                }
                if (this.edition_removed != null) {
                    data.edition_removed = this.edition_removed;
                }
                return data;
            }
            serialize(): Uint8Array;
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                const writer = w || new pb_1.BinaryWriter();
                if (this.has_edition_introduced)
                    writer.writeEnum(1, this.edition_introduced);
                if (this.has_edition_deprecated)
                    writer.writeEnum(2, this.edition_deprecated);
                if (this.has_deprecation_warning && this.deprecation_warning.length)
                    writer.writeString(3, this.deprecation_warning);
                if (this.has_edition_removed)
                    writer.writeEnum(4, this.edition_removed);
                if (!w)
                    return writer.getResultBuffer();
            }
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): FeatureSupport {
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 1:
                            message.edition_introduced = reader.readEnum();
                            break;
                        case 2:
                            message.edition_deprecated = reader.readEnum();
                            break;
                        case 3:
                            message.deprecation_warning = reader.readString();
                            break;
                        case 4:
                            message.edition_removed = reader.readEnum();
                            break;
                        default: reader.skipField();
                    }
                }
    ...
    export class EnumValueOptions extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_feature_support)
                writer.writeMessage(4, this.feature_support, () => this.feature_support.serialize(writer));
            if (this.uninterpreted_option.length)
                writer.writeRepeatedMessage(999, this.uninterpreted_option, (item: UninterpretedOption) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        ...
        export class FeatureSetEditionDefault extends pb_1.Message {
            ...
            constructor(data?: any[] | {
                ...
                if (!Array.isArray(data) && typeof data == "object") {
                    ...
                    if ("overridable_features" in data && data.overridable_features != undefined) {
                        this.overridable_features = data.overridable_features;
                    }
                    if ("fixed_features" in data && data.fixed_features != undefined) {
                        this.fixed_features = data.fixed_features;
                    }
                }
            }
            get edition() {
            ...
            get overridable_features() {
                return pb_1.Message.getWrapperField(this, FeatureSet, 4) as FeatureSet;
            }
            set overridable_features(value: FeatureSet) {
                pb_1.Message.setWrapperField(this, 4, value);
            }
            get has_overridable_features() {
                return pb_1.Message.getField(this, 4) != null;
            }
            get fixed_features() {
                return pb_1.Message.getWrapperField(this, FeatureSet, 5) as FeatureSet;
            }
            set fixed_features(value: FeatureSet) {
                pb_1.Message.setWrapperField(this, 5, value);
            }
            get has_fixed_features() {
                return pb_1.Message.getField(this, 5) != null;
            }
            static fromObject(data: {
                edition?: Edition;
                overridable_features?: ReturnType<typeof FeatureSet.prototype.toObject>;
                fixed_features?: ReturnType<typeof FeatureSet.prototype.toObject>;
            }): FeatureSetEditionDefault {
                const message = new FeatureSetEditionDefault({});
                if (data.edition != null) {
                    message.edition = data.edition;
                }
                if (data.overridable_features != null) {
                    message.overridable_features = FeatureSet.fromObject(data.overridable_features);
                }
                if (data.fixed_features != null) {
                    message.fixed_features = FeatureSet.fromObject(data.fixed_features);
                }
                return message;
            }
            toObject() {
                ...
                if (this.overridable_features != null) {
                    data.overridable_features = this.overridable_features.toObject();
                }
                if (this.fixed_features != null) {
                    data.fixed_features = this.fixed_features.toObject();
                }
                return data;
            }
            serialize(): Uint8Array;
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                ...
                if (this.has_edition)
                    writer.writeEnum(3, this.edition);
                if (this.has_overridable_features)
                    writer.writeMessage(4, this.overridable_features, () => this.overridable_features.serialize(writer));
                if (this.has_fixed_features)
                    writer.writeMessage(5, this.fixed_features, () => this.fixed_features.serialize(writer));
                if (!w)
                    return writer.getResultBuffer();
            }
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 3:
                            ...
                            break;
                        case 4:
                            reader.readMessage(message.overridable_features, () => message.overridable_features = FeatureSet.deserialize(reader));
                            break;
                        case 5:
                            reader.readMessage(message.fixed_features, () => message.fixed_features = FeatureSet.deserialize(reader));
                            break;
                        default: reader.skipField();
                    }
                }
